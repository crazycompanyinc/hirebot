// Vercel serverless — HireBot
let nodemailer;
try { nodemailer = require('nodemailer'); } catch(e) { nodemailer = null; }
const FROM = '"HireBot" <crazycompanyincmail@gmail.com>';
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (type === 'lead') {
      await sendMail(t, { to: email, subject: 'Tus 50 preguntas técnicas para entrevistas', text: 'Las mejores preguntas para evaluar candidatos tech, por seniority y tecnología.\n\nAccede al sistema completo en: https://hirebot.vercel.app' });
      return res.status(200).json({ ok: true });
    }
